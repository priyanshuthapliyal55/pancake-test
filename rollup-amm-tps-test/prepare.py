...
if __name__ == "__main__":
    ...
    # Load funder account from mnemonic
    ...
    # 1. Fund all accounts:
    objects = [Preparer(ChainId.SEPOLIA_TESTNET, funder)]
    # 2. Each account has to wrap enough WETH for swaps (each swap requires 1e-9 WETH)
    # 3. Each account has to approve WETH spending to SMART_ROUTER
    # 4. Check readiness
    # objects = [Preparer(ChainId.SEPOLIA_TESTNET, account) for account in accounts]
